...
BITCOIND_DISTRIBUTION_RPC_USERNAME = get_env_variable(
    'BITCOIND_DISTRIBUTION_RPC_USERNAME')
BITCOIND_DISTRIBUTION_RPC_PASSWORD = get_env_variable(
    'BITCOIND_DISTRIBUTION_RPC_PASSWORD')
BITCOIND_DISTRIBUTION_RPC_URL = get_env_variable(
    'BITCOIND_DISTRIBUTION_RPC_URL')
