...
// TODO:990 document the structure and ordering of a FullCalendar lang file
// TODO:1340 rename everything "lang" to "locale", like what the moment project did
...
// TODO:1260 move to date section?
...
// -------------------------------------------------------------------------------------------------
// TODO:1150 make it work with timezone offset
...
function chunkFormatString(formatStr) {
	var chunks = [];
	var chunker = /\[([^\]]*)\]|\(([^\)]*)\)|(LT|(\w)\4*o?)|([^\w\[\(]+)/g; // TODO:1190 more descrimination
	var match;
...
var Popover = Class.extend({
	...
	// TODO:900 better code reuse for this. Repeat code
...
----------------------------------------------------------------------------------------------------------------------*/
// TODO:1460 very useful to have a handler that gets called upon cellOut OR when dragging stops (for cleanup)
...
var Grid = fc.Grid = RowRenderer.extend({
	...
	colHeadFormat: null, // TODO:1220 move to another class. not applicable to all Grids
	...
	// TODO:1230 move to another class. not applicable to all Grids
	...
	/* Event Helper
	------------------------------------------------------------------------------------------------------------------*/
	// TODO:1380 should probably move this to Grid.events, like we did event dragging / resizing
	...
	// Responsible for populating this.elsByFill. TODO:890 better API for expressing this requirement
	...
	// TODO:1240 move to another class. not applicable to all Grids
	headHtml: function() {
		return '' +
	...
	// TODO:1250 move to another class. not applicable to all Grids
...
Grid.mixin({
	...
	// Called by the fill system.
	// TODO:930 consolidate with getEventSkinCss?
...
var DayGrid = Grid.extend({
	...
	numbersVisible: false, // should render a row for day/week numbers? set by outside view. TODO:1140 make internal
	...
	------------------------------------------------------------------------------------------------------------------*/
	// TODO:1210 move to DayGrid.event, similar to what we did with Grid's drag methods
...
DayGrid.mixin({
	...
	computeRowLevelLimit: function(row) {
		...
		var rowHeight = rowEl.height(); // TODO:910 cache somehow?
...
var View = fc.View = Class.extend({
	...
	documentMousedownProxy: null, // TODO:1000 doesn't work with touch
	...
	trigger: function(name, thisObj) { // arguments beyond thisObj are passed along
		...
		return calendar.trigger.apply(
			...
			[name, thisObj || this].concat(
				...
				[ this ] // always make the last argument a reference to the view. TODO:960 deprecate
			)
		);
	},
	...
	reportExternalDrop: function(meta, dropLocation, el, ev, ui) {
		...
		// Try to build an event object and render it. TODO:950 decouple the two
		if (eventProps) {
	...
	t.getDefaultEventEnd = function(allDay, start) { // TODO:1360 rename to computeDefaultEventEnd
		var end = start.clone();
	...
	-----------------------------------------------------------------------------*/
	// TODO:1030 going forward, most of this stuff should be directly handled by the view
...
----------------------------------------------------------------------------------------------------------------------*/
// TODO:1330 rename all header-related things to "toolbar"
...
function EventManager(options) { // assumed to be a calendar
	...
	function buildEventSource(sourceInput) { // will return undefined if invalid source
		...
		if (source) {
			...
			// TODO:1370 repeat code, same code for event classNames
			if (source.className) {
	...
	// TODO:1180 make this a part of the event -> eventRange system
	...
	//
	// TODO:1010 don't use so many closures. possible memory issues when lots of events with same ID.
	//
	...
	function isRangeAllowed(range, constraint, overlap, event) {
		...
		if (constraint != null) {
			...
			// TODO:1430 use ranges in the future
...
var BasicView = fcViews.basic = View.extend({
	...
	render: function() {
		...
		this.dayNumbersVisible = this.dayGrid.rowCnt > 1; // TODO:1130 make grid responsible
